...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border px-2.5 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ascent-blue focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "border-transparent bg-ascent-blue-subtle text-ascent-blue",
        ...
        method_llm: "border-ascent-blue text-ascent-blue bg-ascent-blue/5",
